...
<body>
		...
		<g:form controller="administrador">
			...
			<div align="center">
				<label for="nombre2"> <g:message code="Nombre:" /></label> <label
					for="nombre"> <g:message code="${unAdmi.username}" /></label><br>
				<label for="apellido2"> <g:message code="Apellido:" /></label> <label
					for="apellido"> <g:message code="${unAdmin.username}" /></label><br>
			<div align="center">
				<g:actionSubmit class="btn" controller="administrador"
					action="editar" value="Editar" />
				<g:actionSubmit class="btn" controller="administrador" action="ok"
					value=" OK " />
			</div>
		</g:form>
	</g:if>
	<g:else>
		<div class="row" align="center">
			<div class="alert alert-danger">¡OOOPs! Este administrador no existe...</div>
		</div>
		<div align="center">
			<g:form controller="administrador">
				<g:actionSubmit class="btn" controller="administrador" action="index"
					value="Volver" />
			</g:form>
		</div>
	</g:else>
